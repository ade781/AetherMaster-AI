...
export default function GameOverModal({
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-black/90 backdrop-blur-xl animate-fadeIn select-none">
      {/* Dark crimson vignette glow */}
      <div className="absolute inset-0 bg-gradient-radial from-rose-950/30 via-black/80 to-black pointer-events-none" />

      <div className="relative w-full max-w-lg bg-slate-950/95 border-2 border-rose-900/60 rounded-3xl p-8 shadow-2xl shadow-rose-950/50 flex flex-col items-center text-center overflow-hidden">
        ...
        {/* Skull Icon Emblem */}
        <div className="w-20 h-20 rounded-2xl bg-rose-950/40 border-2 border-rose-700/60 flex items-center justify-center text-rose-500 mb-6 shadow-xl shadow-rose-950/40 animate-pulse">
          <Skull className="w-10 h-10" />
        </div>

        {/* Title */}
        <h2 className="font-cinzel text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-rose-400 via-rose-200 to-rose-400 tracking-wider mb-2">
          TAKDIR BERAKHIR
        </h2>
        <p className="text-xs uppercase tracking-widest text-rose-400/80 font-bold mb-4 flex items-center gap-1.5">
